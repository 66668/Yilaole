...
import com.yilaole.adapter.mine.MineDoorAssessRecyclerViewAdapter2;
...
import com.yilaole.presenter.MineDoorAssessListPresenterImpl;
...
public class MineDoorAssessListActivity extends BaseActivity implements OnMoreAndRefreshListener, SwipeRefreshLayout.OnRefreshListener, BaseQuickAdapter.RequestLoadMoreListener {
    //
    ...
    private List<DoorAssessItemBean> listData;
    private MineDoorAssessRecyclerViewAdapter2 adapter;
    private MineDoorAssessListPresenterImpl presenter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_mine_doorassess);
    ...
    private void initMyView() {
        ...
        presenter = new MineDoorAssessListPresenterImpl(this, this);
    ...
    private void initShow() {
        adapter = new MineDoorAssessRecyclerViewAdapter2(this, listData);
        ...
        adapter.setOnItemChildClickListener(new BaseQuickAdapter.OnItemChildClickListener() {
            ...
            public void onItemChildClick(BaseQuickAdapter adapter, View view, int position) {
                DoorAssessItemBean bean = (DoorAssessItemBean) adapter.getItem(position);
                Bundle bundle = new Bundle();
                switch (view.getId()) {
                    case R.id.layout_item:
                        bundle.putInt("id", bean.getId());//订单id
                        startActivity(MineDoorAssessDetailActivity.class, bundle);
                        break;
                    case R.id.tv_assess:
                        bundle.putInt("id", bean.getAgencyid());//机构id
    ...
    public void onListSuccess(Object bean) {
        ...
        listData = (List<DoorAssessItemBean>) bean;
        initShow();
    }
