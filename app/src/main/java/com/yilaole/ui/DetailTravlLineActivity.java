...
public class DetailTravlLineActivity extends BaseActivity implements OnCommonListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_detail_travalline);
    ...
    private void initShow() {
        //
        tv_content.setText(dataList.get(0).getTravel());

    }

    private void initMyView() {
        tv_title.setText(getResources().getString(R.string.instite_detail_chengcheluxian));
        presenter = new DetailTravalLinePresenterImpl(DetailTravlLineActivity.this, this);
