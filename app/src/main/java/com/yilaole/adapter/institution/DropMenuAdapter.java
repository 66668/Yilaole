...
import com.yilaole.bean.institution.filter.AreaBean;
import com.yilaole.bean.institution.filter.CityBean;
...
import com.yilaole.filter.FilterTypeBean;
import com.yilaole.filter.adapter.MenuAdapter;
import com.yilaole.filter.adapter.SimpleTextAdapter;
import com.yilaole.filter.interfaces.OnFilterDoneListener;
import com.yilaole.filter.typeview.DoubleGridView;
import com.yilaole.filter.typeview.DoubleListView;
import com.yilaole.filter.typeview.MultiGridView;
import com.yilaole.filter.typeview.SingleGridView;
import com.yilaole.filter.typeview.SingleListView;
import com.yilaole.filter.typeview.ThreeListView;
import com.yilaole.filter.util.CommonUtil;
import com.yilaole.filter.util.FilterUtils;
